...
description: "Run claude-meta-settings natively (Node + PostgreSQL) without Docker"
---

claude-meta-settings is just **two Node processes plus PostgreSQL**, so it can run directly on a
