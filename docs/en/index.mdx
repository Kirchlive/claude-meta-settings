---
title: "claude-meta-settings Documentation"
description: "MCP Aggregator, Orchestrator, Middleware, Gateway in one docker"
---

<div align="center">

<img src="/images/metamcp.svg" alt="claude-meta-settings Diagram" style={{ width: "100%", maxWidth: "600px", margin: "2rem 0" }} />
...
<CardGroup cols={2}>
  ...
  <Card title="Enhanced Inspector" icon="search-code">
    Use as enhanced MCP inspector with saved server configs, and inspect your claude-meta-settings endpoints.
  </Card>
...
<div align="center">
  <img src="/images/metamcp_screenshot.png" alt="claude-meta-settings Screenshot" style={{ width: "100%", maxWidth: "800px", margin: "2rem 0", borderRadius: "8px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)" }} />
</div>

## Quick Start

Get claude-meta-settings running in minutes with Docker Compose:
...
Understanding these key concepts will help you get the most out of claude-meta-settings:
...
Connect claude-meta-settings to your favorite tools and platforms:

<CardGroup cols={2}>
  <Card title="Cursor" icon="mouse-pointer-2" href="/en/integrations/cursor">
    Configure Cursor to use claude-meta-settings endpoints via mcp.json
  </Card>
...
<CardGroup cols={2}>
  <Card title="Contributing to claude-meta-settings" icon="code" href="/en/development/contributing">
    Set up a local development environment and contribute to claude-meta-settings.
  </Card>
   <Card title="API Reference" icon="book" href="/en/api-reference/introduction">
    Explore the complete API documentation for claude-meta-settings endpoints.
  </Card>
  <Card title="GitHub Issues" icon="github" href="https://github.com/Kirchlive/claude-meta-settings/issues">
