...
description: "Add multi-language support to claude-meta-settings with Next.js locale routing and client-side translations"
---

claude-meta-settings uses **Next.js locale-based routing** and **client-side translations** to support multiple languages. This guide explains the i18n system and how to add new languages.

## Current Language Support

claude-meta-settings currently supports:
...
claude-meta-settings uses locale-based routing:
...
When adding new features to claude-meta-settings:
...
<CardGroup cols={2}>
  <Card title="Contributing Guide" icon="handshake" href="/en/development/contributing">
    Learn how to contribute to claude-meta-settings development
  </Card>
