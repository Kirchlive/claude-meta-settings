---
title: "Contributing to claude-meta-settings"
description: "Learn how to contribute to claude-meta-settings development and help improve the project"
---

We welcome contributions to claude-meta-settings! This comprehensive guide will help you get started with contributing to the project, whether you're fixing bugs, adding features, or improving documentation.
...
<AccordionGroup>
  <Accordion icon="github" title="Fork and Clone">
    ...
    3. **Add upstream remote**:
       ```bash
       git remote add upstream https://github.com/Kirchlive/claude-meta-settings.git
       ```
  </Accordion>
...
<AccordionGroup>
  <Accordion icon="bug" title="Reporting Bugs">
    **Before reporting a bug:**
    ...
    3. Gather relevant information (OS, browser, claude-meta-settings version)
    ...
    **Bug report template:**
    ...
    - claude-meta-settings Version: [e.g., 1.0.0]
...
claude-meta-settings supports OpenID Connect for enterprise SSO. When working on OIDC features:
...
We appreciate all contributions to claude-meta-settings! Contributors are recognized through:

- **GitHub contributors list** on the repository
- **Release notes** mentioning significant contributions

Thank you for helping make claude-meta-settings better for everyone! 🚀

## Next Steps

<CardGroup cols={1}>
  <Card title="Start Contributing" icon="rocket" href="https://github.com/Kirchlive/claude-meta-settings/issues">
