...
Common issues and solutions when integrating claude-meta-settings with various tools and platforms.
...
**Symptoms**: Client cannot connect to claude-meta-settings server
...
**Symptoms**: claude-meta-settings tools don't show up in Claude Desktop
...
**Symptoms**: claude-meta-settings extension fails to load in Cursor
...
3. **Check extension logs**:
   ...
   - Go to Console tab
   - Look for claude-meta-settings-related errors

#### Tool Suggestions Not Working

**Symptoms**: Code completion doesn't include claude-meta-settings tools

**Solutions**:

1. **Refresh tool cache**:
   - Command Palette → "claude-meta-settings: Refresh Tools"
   - Or restart Cursor
...
**Symptoms**: Cannot resolve claude-meta-settings domain
...
echo "=== claude-meta-settings Health Check ==="
...
1. **Environment details**:
   ...
   - claude-meta-settings server version
...
- **GitHub Issues**: https://github.com/Kirchlive/claude-meta-settings/issues
