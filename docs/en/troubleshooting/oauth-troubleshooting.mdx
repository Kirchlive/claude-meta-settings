...
description: "This page explains the authentication logic in claude-meta-settings exposed MCP endpoints and helps troubleshoot common OAuth-related issues."
---

> **Implementation Reference**: The authentication logic described in this page is implemented in [`apps/backend/src/middleware/api-key-oauth.middleware.ts`](https://github.com/Kirchlive/claude-meta-settings/blob/main/apps/backend/src/middleware/api-key-oauth.middleware.ts).

## Authentication Scenarios

claude-meta-settings supports four different authentication configurations, each with specific behaviors:
...
```json
{
  ...
  "WWW-Authenticate": "Bearer realm=\"claude-meta-settings\", scope=\"admin\""
}
```
