...
A **Namespace** in claude-meta-settings is a logical grouping of MCP servers that allows you to organize multiple servers into a single unified MCP endpoint.
...
1. **Navigate** to Namespaces in the claude-meta-settings dashboard
...
claude-meta-settings gateways, `originalToolName` can itself contain nested prefixes (for
