...
This runs the backend on port 12009 and the frontend on port 12008. You need a PostgreSQL 16 instance reachable via `DATABASE_URL` (see `deploy/native-deployment.md`).
